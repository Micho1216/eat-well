        ...
        <form action="{{ route('store-address') }}" method="POST" id="addressForm" novalidate>
            ...
            <div class="row justify-content-center mb-4">
                ...
                <div class="col-sm-3">
                    ...
                    <div class="invalid-feedback" data-message-required="{{ __('add-address.required.subdistrict') }}"></div>
                </div>
            </div>
            ...
            <div class="row justify-content-center mb-4">
                <div class="col-sm-9">
                    <div class="mb-3">
                        <input class="form-control form-control-sm" type="text" placeholder="{{ __('add-address.address') }}"
                            name="jalan" required maxlength="255">
                        <div class="invalid-feedback">{{ __('add-address.required.address') }}</div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <input class="form-control form-control-sm" type="text" placeholder="{{ __('add-address.zipcode') }}"
                        name="kode_pos" required pattern="[0-9]{5}" minlength="5" maxlength="5">
                    <div class="invalid-feedback"
                        data-message-required="{{ __('add-address.required.zipcode') }}"
            ...
            <div class="row justify-content-center mb-4">
                <div class="col-sm-12">
                    <div class="mb-3">
                        <input class="form-control form-control-sm" type="text" placeholder="{{ __('add-address.note') }}"
                            name="notes" maxlength="255">
                        <div class="invalid-feedback">
            ...
            <div class="row justify-content-center mb-4">
                <div class="col-sm-3">
                    <div class="mb-3">
                        <input class="form-control form-control-sm" type="text" placeholder="{{ __('add-address.recipient_name') }}"
                            name="recipient_name" required maxlength="100">
                        <div class="invalid-feedback">
                ...
                <div class="col-sm-3">
                    <div class="mb-3">
                        <input class="form-control form-control-sm" type="text" placeholder="{{ __('add-address.recipient_phone') }}"
                            name="recipient_phone" required pattern="[0-9]+" minlength="10" maxlength="15">
                        <div class="invalid-feedback"
                ...
                <div class="col-sm-3">
                    <div class="mb-3">
                        <button type="submit" class="btn btn-success btn-sm" style="width: 140px">{{ __('add-address.save') }}</button>
                    </div>
                </div>

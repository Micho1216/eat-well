            ...
            <div class="col-12 col-sm-8 col-md-6 col-lg-6 col-xl-4 my-5">
                <div class="card text-bg-light rounded-5 d-block" id="login-card">
                    <div class="card-body p-5 p-sm-5">
                        <div class="h5 card-title text-center mb-5">{{ __('auth/customer-register.title') }}</div>
                        <form action="{{ route('register', ['role' => 'customer']) }}" method="post" novalidate>
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <label for="name" class="form-label m-0">{{ __('auth/customer-register.name') }}</label>
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <label for="email" class="form-label m-0">{{ __('auth/customer-register.email') }}</label>
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <label for="password" class="form-label m-0">{{ __('auth/customer-register.password') }}</label>
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <label for="password_confirmation" class="form-label m-0">{{ __('auth/customer-register.password_confirmation') }}</label>
                            ...
                            <button type="submit" class="mb-2 mt-4 w-100 gsi-material-button w-100">
                                ...
                                <div class="gsi-material-button-content-wrapper">
                                    <span class="gsi-material-button-contents">{{ __('auth/customer-register.register') }}</span>
                                </div>
                            </button>
                        </form>
                        ...
                        <a href="{{ route('auth.redirect', ['provider'=>'google', 'role' => 'customer']) }}">
                            <button class="gsi-material-button w-100">
                                ...
                                <div class="gsi-material-button-content-wrapper">
                                    ...
                                    <span class="gsi-material-button-contents">{{ __('auth/customer-register.google') }}</span>
                                </div>
                            </button>
                        </a>
                        
                        <div class="row justify-content-center p-2">
                            <a href="{{ url('/login') }}" class="btn btn-link change-card-link text-center w-auto p-0">{{ __('auth/customer-register.sign_in_link') }}</a>
                            <p class="text-center change-card-link m-0">{{ __('auth/customer-register.or') }}</p>
                            <a href=" {{ url('/register/vendor') }}" class="btn btn-link change-card-link text-center w-auto p-0">{{ __('auth/customer-register.vendor_register_link') }}</a>
                        </div>
                    </div>
                </div>
